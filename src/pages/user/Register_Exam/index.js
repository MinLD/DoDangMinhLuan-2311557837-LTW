    ...
    return (
        ...
        <div className="container-big bg_sub" >
            ...
            <div className="Regis_Ex-List">
                <h3>Khóa học luyện thi TOEIC Speaking & Writing toàn diện</h3>
                <ul>
                    <li>
            ...
            <div className="Regis_Ex-List">
                <h3>Khóa học luyện đề TOEIC chuyên sâu</h3>
                <ul>
                    <li>
                        <div className="Regis_Ex-List_card">
                           
                           <img src="https://han01.vstorage.vngcloud.vn/v1/AUTH_6831ce3c90cd4f47a8ca18d6545cddf9/public/Course/Media/Images/ceb51afc-77e3-45b3-9163-f8024b9009ec/image_ceb51afc-77e3-45b3-9163-f8024b9009ec_toeic-practice-test-450_small_1727939282782.png"/>
                           <span  className="Regis_Ex-List_card_item">
                           <h5>TOEIC PRACTICE ONLINE 450+</h5>
                           <span className="Rating"><span><FaStar /> <FaStar /> <FaStar /> <FaStar /> <FaStar /></span> 5 (100tr)</span>
                           <span className="monney_container">
                           <span className="monney_left">890.000đ</span>
                    ...
                    <li>
                        <div className="Regis_Ex-List_card">
                           ...
                           <img src="https://han01.vstorage.vngcloud.vn/v1/AUTH_6831ce3c90cd4f47a8ca18d6545cddf9/public/Course/Media/Images/1da3eff7-18da-4b37-a92f-f31ef0402d29/image_1da3eff7-18da-4b37-a92f-f31ef0402d29_toeic-practice-test-650_small_1727939302005.png"/>
                           <span  className="Regis_Ex-List_card_item">
                           <h5>TOEIC PRACTICE ONLINE 650+</h5>
                           <span className="Rating"><span><FaStar /> <FaStar /> <FaStar /> <FaStar /> <FaStar /></span> 5 (100tr)</span>
                           <span className="monney_container">
                           <span className="monney_left">890.000đ</span>
                           <span className="monney_right">659.000đ</span>
...
export default memo( REGISTER_EXAM);